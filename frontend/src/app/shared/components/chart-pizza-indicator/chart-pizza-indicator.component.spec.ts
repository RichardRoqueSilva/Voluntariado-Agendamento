...
import { ChartPizzaData } from '../../models/chart';
import { FontSizeService } from '../../services/font-size';
import { TestingModule } from '../../tests';
import { ChartPizzaIndicatorComponent } from './chart-pizza-indicator.component';

describe(ChartPizzaIndicatorComponent.name, () => {
  let component: ChartPizzaIndicatorComponent;
  let fixture: ComponentFixture<ChartPizzaIndicatorComponent>;
  let fontSizeService: FontSizeService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ChartPizzaIndicatorComponent, TestingModule],
    }).compileComponents();

    fixture = TestBed.createComponent(ChartPizzaIndicatorComponent);
  ...
  it(`DEVE montar labels para o formatdo do Chartjs
    ...
    const labels = component.pizzaChartData.labels;
  ...
  it(`DEVE montar valores para o formatdo do Chartjs
    ...
    const data = component.pizzaChartData.datasets[0].data;
  ...
  it(`DEVE alterar tamanho da fonte do título do tooltip para 32px
    ...
    const tituloTooltip = component.pizzaChartOptions?.plugins?.tooltip
  ...
  it(`DEVE alterar tamanho da fonte do corpo do tooltip para 32px
    ...
    fontSizeService.notifyFontSizeChange(2);
    const corpoTooltip = component.pizzaChartOptions?.plugins?.tooltip
  ...
  it(`DEVE alterar tamanho da fonte do rodapé do tooltip para 32px
    ...
    fontSizeService.notifyFontSizeChange(2);
    const rodapeTooltip = component.pizzaChartOptions?.plugins?.tooltip
